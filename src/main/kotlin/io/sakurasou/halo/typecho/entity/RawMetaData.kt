...
data class RawMetaData(
    val layout: String?, val cid: Long?, val title: String?, val slug: String?, val date: String,
    val updated: String?, val status: String?, val author: String?, val categories: List<String>?,
